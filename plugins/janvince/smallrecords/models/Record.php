...
class Record extends Model
{
    ...
    public $belongsTo = [
        ...
        'record_list' => [
            'JanVince\SmallRecords\Models\RecordList',
            'key' => 'list_id',
        ],
    ...
    public $attachOne = [
        ...
        'video' => ['System\Models\File', 'public' => true],
    ];
...
{
    static::addGlobalScope('filterByList', function ($builder) {
        if ($listId = session('current_list_id')) {
            $builder->where('list_id', $listId);
        }
    });
}
    /**
    ...
    */
    ...
    {
        $perPage = array_get($options, 'perPage', 10); // Количество записей на странице
