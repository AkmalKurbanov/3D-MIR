...
class top_menu {
    constructor() {
        this.obj = document.querySelector(".top-menu");
        this.opened = !1;
    }
    toggle() {
        ...
        if (
            ...
            document.querySelector(".header-menu__btn").classList.add("closed");
        } else {
            document
                .querySelector(".header-menu__btn")
                .classList.remove("closed");
            document.querySelector(".header-menu__btn").classList.add("opened");
        }
...
document.querySelector(".header-menu__btn").addEventListener("click", () => {
    top_menu.toggle();
    document.querySelector(".header-menu__btn").blur();
});
!(function (e, t) {
...
document.addEventListener(
    ...
    function (event) {
        ...
        if (
            ...
            console.log("РћС‚РїСЂР°РІР»РµРЅРѕ");
...
window.addEventListener("DOMContentLoaded", function (event) {
    function galleryThumbs_create() {
        if (window.innerWidth > 576 && typeof galleryThumbs == "undefined") {
            galleryThumbs = new Swiper(".sidebar-slider", {
                spaceBetween: 2,
                direction: "vertical",
                slidesPerView: 5,
                loop: !1,
    ...
    var galleryTop = new Swiper(".gallery-top", {
        ...
        effect: "fade",
        loopedSlides: 5,
        pagination: { el: ".sidebar-dots", type: "bullets", clickable: !0 },
        breakpoints: { 576: { pagination: !1 } },
        navigation: {
            nextEl: ".swiper-button-next",
            prevEl: ".swiper-button-prev",
        },
        thumbs: {
            swiper: typeof galleryThumbs !== "undefined" ? galleryThumbs : !1,
        },
        autoplay: { delay: 4000 },
    });
    galleryTop.on("slideChangeTransitionStart", function () {
        document.querySelector(".front-slide-title").style.opacity = 0;
        document.querySelector(".front-slide-title").innerText = document
            .querySelector(".gallery-top .swiper-slide.swiper-slide-active")
            .getAttribute("data-title");
        document.querySelector(".front-slide-link").href = document
            .querySelector(".gallery-top .swiper-slide.swiper-slide-active")
            .getAttribute("data-href");
        document.querySelector(".front-slide-category").innerText = document
            .querySelector(".gallery-top .swiper-slide.swiper-slide-active")
            .getAttribute("data-category");
        document.querySelector(".front-slide-category").href = document
            .querySelector(".gallery-top .swiper-slide.swiper-slide-active")
            .getAttribute("data-category-link");
        document.querySelector(".front-slide-title").style.opacity = 1;
    });
    window.addEventListener("load", function () {
        const sliderArrowBottom = document.querySelector(
            ".slider-arrow-bottom"
        );

        if (sliderArrowBottom) {
            sliderArrowBottom.addEventListener("click", function () {
                const anchorElement = document.querySelector("[data-ankor]");
                const headerElement = document.querySelector(".header");

                if (anchorElement && headerElement) {
                    window.scroll(
                        0,
                        anchorElement.offsetTop - headerElement.offsetHeight
                    );
                }
            });
        }
    ...
    var partnersSlider = new Swiper(".partners-slider", {
        ...
        autoplay: { delay: 4000 },
        breakpoints: {
            650: { spaceBetween: 80, slidesPerView: 3, freeMode: !0 },
            1200: { spaceBetween: 100, slidesPerView: 5, freeMode: !0 },
        },
    });
...
window.addEventListener("DOMContentLoaded", function () {
    var cs_slider = new Swiper(".cs_slider", {
        spaceBetween: 20,
        freeMode: !0,
        slidesPerView: 1.5,
        pagination: { el: ".swiper-pagination", type: "progressbar" },
        breakpoints: {
            750: { spaceBetween: 30, slidesPerView: 2.5 },
            1120: { slidesPerView: 2, freeMode: !1 },
            1300: { slidesPerView: 2, spaceBetween: 95 },
        },
    });
});
function update_case(t) {
    document.querySelector(
        '[data-id="1126113411241136"] .content-case-title'
    ).innerText = t.getAttribute("data-case-title");
    document.querySelector(
        '[data-id="1126113411241136"] .content-case__detail'
    ).href = t.getAttribute("data-case-link");
}
window.addEventListener("DOMContentLoaded", function () {
    var contentSliderSwiper_1126113411241136 = new Swiper(
        "#content-slider-swiper-1126113411241136",
        {
            spaceBetween: 0,
            freeMode: !1,
            slidesPerView: 1,
            pagination: { el: ".swiper-pagination", type: "bullets" },
            breakpoints: { 650: { spaceBetween: 8, slidesPerView: "auto" } },
        }
    );
    contentSliderSwiper_1126113411241136.on(
        "slideChangeTransitionStart",
        function () {
            update_case(
                document.querySelector(
                    "#content-slider-swiper-1126113411241136 .swiper-slide.swiper-slide-active"
                )
            );
        }
    );
