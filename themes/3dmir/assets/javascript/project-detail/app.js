        ...
        (window.vc_plugin_flexslider = function ($parent) {
            ($parent
                ...
                var this_element = jQuery(this),
                    sliderTimeout =
                        1e3 * parseInt(this_element.attr("data-interval")),
                ...
                var $call = $tab || jQuery(".wpb_tabs, .wpb_tour"),
                    ver =
                        jQuery.ui && jQuery.ui.version
                            ...
                            : "1.10",
                    old_version =
                        1 === parseInt(ver[0]) && parseInt(ver[1]) < 9;
        ...
        (window.vc_carouselBehaviour = function ($parent) {
            ($parent
                ...
                if (
                    ...
                    var carousele_li = jQuery(this).find(
                ...
                $.each($elements, function (key, item) {
                    ...
                    if (
                        ...
                        var padding,
                            ...
                            offset =
                                0 - $el_full.offset().left - el_margin_left,
                            width = $(window).width();
                        if (
...
(function (global, factory) {
    ...
    function getOuterSize(data) {
        ...
        return { aspect: width / height, height: height, width: width };
    }
    ...
    function applyLayout(data) {
        ...
        if (
            ...
            data.canvas[0].width =
                layout.width * data.canvasRatio || size.width;
            data.canvas[0].height =
                layout.height * data.canvasRatio || size.height;
        } else {
    ...
    function create(options) {
        ...
        var data = $$2.extend(!0, {}, defaults, options);
    ...
    function extension(option, value) {
        ...
        if (typeof option === "object") {
            return createOrUpdate($$1.extend(!0, { target: $target }, option))
                .target;
        }
    ...
    var changeEvent =
        browser.fullscreenchange + "." + namespace + "-fullscreen";
    ...
    (function () {
        ...
        registerPlugin(NAME, { name: NAME, mouseup: click, touchend: click });
    })();
    (function () {
        var NAME = "drag";
        ...
        function drag(e, data) {
            ...
            var y =
                (input.nddX * sn + input.nddY * cs) *
                    (data.senseLane || data.sense) || 0;
    ...
    (function () {
        ...
        registerPlugin(NAME, { name: NAME, wheel: wheel });
    })();
    (function () {
        var template =
        ...
        function onInit(e, data) {
            ...
            state.stage.find(".spritespin-progress-bar").css({ width: "0%" });
    ...
    (function () {
        ...
        registerPlugin(NAME, { name: NAME, onLoad: onLoad, onDraw: onDraw });
    })();
    (function () {
        var NAME = "blur";
        function getState$$1(data) {
        ...
        function init(e, data) {
            ...
            state.cssBlur = !!getOption(data, "blurCss", !1);
            var inner = getInnerSize(data);
            var outer = data.responsive
        ...
        function removeOldFrames(frames) {
            ...
            for (
                var _i = 0, toRemove_1 = toRemove;
                _i < toRemove_1.length;
                _i++
            ) {
        ...
        function applyCssBlur(canvas, d) {
            ...
            canvas.css({ "-webkit-filter": blur, filter: blur });
        }
    ...
    (function () {
        ...
        function init(e, data) {
            ...
            state.damping = max(
                min(getOption(data, "easeDamping", 0.9), 0.999),
                0
            );
    ...
    (function () {
        ...
        function load(e, data) {
            ...
            for (var _i = 0, _a = data.images; _i < _a.length; _i++) {
                ...
                state.offsets.push(
                    -size + (data.width - image.width * scale) / 2
                );
                size += data.width;
                img.css({
                    "max-width": "initial",
        ...
        registerPlugin(NAME, { name: NAME, onLoad: load, onDraw: draw });
    })();
    (function () {
        var NAME = "panorama";
        function getState$$1(data) {
    ...
    (function () {
        ...
        function onInit(e, data) {
            ...
            state.useWheel = getOption(data, "zoomUseWheel", !1);
            state.useClick = getOption(data, "zoomUseClick", !0);
            state.pinFrame = getOption(data, "zoomPinFrame", !0);
        ...
        function toggleZoom(data) {
            ...
            if (!state.stage) {
                throw new Error(
                    "zoom module is not initialized or is not available."
                );
            }
            if (state.stage.is(":visible")) {
                showZoom(data);
...
document.addEventListener("DOMContentLoaded", () => {
    jQuery(".spritespin").each((index, item) => {
        let items = JSON.parse(jQuery(item).attr("data-slider-items"));
        console.log(items);
        jQuery(item)
            .find(".spritespin__frame")
            .spritespin({
                source: items,
                animate: !1,
                width: 300,
                ...
                onFrame: function (e, data) {
                    jQuery(item).find(".spritespin__slider").val(data.frame);
                },
            });
    });
});
